...
- (void)layoutSubviews
{
    ...
    _favouriteButton.frame = CGRectMake(70, bounds.size.height - 30, 40, 20);
    _replyButton.frame = CGRectMake(70 + 40 + 20, bounds.size.height - 30, 40, 20);
    _retweetButton.frame = CGRectMake(70 + 80 + 40, bounds.size.height - 30, 40, 20);
    ...
    if ([_content[@"type"] isEqualToString:@"text"]) {
        CGRect contentSize;
        contentSize = [_content[@"text"] boundingRectWithSize:CGSizeMake(223, CGFLOAT_MAX) options:NSStringDrawingUsesLineFragmentOrigin context:nil];
